...
echo
gunzip -c test.28Sep18.793.vcf.gz | cut -f1-190 | tr '/' '|' | gzip > ref.28Sep18.793.vcf.gz
gunzip -c test.28Sep18.793.vcf.gz | cut -f1-9,191-200 | gzip > target.28Sep18.793.vcf.gz
...
echo
beagle ref=ref.28Sep18.793.vcf.gz gt=target.28Sep18.793.vcf.gz out=out.ref
...
echo
beagle ref=ref.28Sep18.793.bref3 gt=target.28Sep18.793.vcf.gz out=out.bref3
